var panaPtzCommands = [
    ...
    {commandResponse : 'pE00', commandRegex : '//', commandName : 'Preset Entry No.001~040' },
    {commandResponse : 'pE01', commandRegex : '//', commandName : 'Preset Entry No.041~080' },
    {commandResponse : 'pE02', commandRegex : '//', commandName : 'Preset Entry No.081~100' },
    {commandResponse : 'rER', commandRegex : '//', commandName : 'Error information' },
    {commandResponse : 'rt', commandRegex : '//', commandName : '' },
    {commandResponse : 's', commandRegex : '//', commandName : '' },
    {commandResponse : 'sWZ', commandRegex : '//', commandName : 'Zoom position-linked pan/tilt speed adjustment On/Off' },
    {commandResponse : 'TITLE:', commandRegex : '//', commandName : 'Camera name' },
    {commandResponse : 'uPVS', commandRegex : '//', commandName : 'Preset Speed'},
]